...
- **Próximo passo imediato:** aluno executa o notebook no Colab. Após primeiro treino: comparar `balanced_accuracy` com vs sem peso (ablação ADR-0007) e validar com orientador antes de avançar para ViT-Base/Swin-T.
